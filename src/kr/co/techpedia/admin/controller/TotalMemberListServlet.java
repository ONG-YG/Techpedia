...
/**
 * Servlet implementation class TotalMemberListServlet
 */
@WebServlet(name = "TotalMemberList", urlPatterns = { "/totalMemberList.do" })
public class TotalMemberListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TotalMemberListServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pd = new AdminService().totalMemberList(currPg);
