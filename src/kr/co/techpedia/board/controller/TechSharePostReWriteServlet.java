...
/**
 * Servlet implementation class TechSharePostReWriteServlet
 */
@WebServlet(name = "TechSharePostReWrite", urlPatterns = { "/techSharePostReWrite.do" })
public class TechSharePostReWriteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TechSharePostReWriteServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(memSession!=null
				...
				int result = new BoardService().updateTechShare(postNo, title, content, fileName);
