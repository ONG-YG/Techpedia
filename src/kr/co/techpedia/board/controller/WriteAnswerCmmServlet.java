 ...
 */
@WebServlet(name = "WriteAnswerCmm", urlPatterns = { "/writeAnswerCmm.do" })
public class WriteAnswerCmmServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WriteAnswerCmmServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(memSession!=null) {
				...
				String sppStatSelect = request.getParameter("sppStatSelect");
				String comment = request.getParameter("comment");
				
				int result = new BoardService().insertAnswerCmm(sppStatSelect, comment, memberNo, postNo, boardCD);
