 ...
 */
@WebServlet(name = "UpdateComment", urlPatterns = { "/updateComment.do" })
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(memSession!=null) {
				...
				String commentRe = request.getParameter("commentRe");
				
				int result = new BoardService().updateComment(cmmNo, commentRe);
