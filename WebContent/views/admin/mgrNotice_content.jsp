...
<head>
	...
	<link href="/css/mgrNotice_content.css" rel="stylesheet" type="text/css">
	...
	<script>
        ...
        function alreadyChecked(){
        	alert("이미 메인페이지에 게시 중인 공지사항입니다.");
        }
        
        function chkMainView(postNo){
        	
           	$.ajax({
   				url : "/updateNoticeMainView.do",
   				data : {postNo: postNo},
   				type : "post",
   				success : function(data){
   					//console.log("정상 처리 완료");
   					...
   					//console.log(data);////////////////////
   					if(data) {
   						alert("성공적으로 메인페이지에 공지사항 게시 설정을 완료했습니다.");
   						noticeBoardList();
   					}
   					else {
